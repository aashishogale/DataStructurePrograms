...
public class ListImpl<T> {
	...
	public static SinglyLinkedListImpl<String> slist = new SinglyLinkedListImpl<String>();
	public static SinglyLinkedListImpl<Integer> olist = new SinglyLinkedListImpl<Integer>();
